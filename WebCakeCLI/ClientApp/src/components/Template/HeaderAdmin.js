    ...
    render() {
        return (
            <nav className="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div className="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center col-2">
                    <Link to='/'>
                ...
                <div className="navbar-menu-wrapper d-flex align-items-center col-10">
